...
Автор не несет ответственности за любые финансовые потери.

📜 Лицензия
MIT License. Код предоставляется «как есть» для образовательных целей. Архитектура открыта, однако конкретные веса модели и полные датасеты могут быть защищены авторским правом их владельцев.
