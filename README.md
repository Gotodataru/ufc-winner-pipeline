...
Лучшая стратегия по результатам: high_odds_strict (кф 1.35–17.00)
...
Активная стратегия в коде (run.py) — medium_high_value (кф 2.8–5.0) для меньшего количества ставок.
